...
def process_data():
    ...
    bucket = "my_airflow_projects"
    #my_airflow_projects/my_airflow_project_01/data
    emp_data_path = f"gs://{bucket}/my_airflow_project_01/data/employee.csv"
    dept_data_path = f"gs://{bucket}/my_airflow_project_01/data/department.csv"
    output_path = f"gs://{bucket}/my_airflow_project_01/output"
